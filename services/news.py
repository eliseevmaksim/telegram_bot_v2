    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "Ты новостной редактор. Сделай краткую сводку главных новостей на русском языке. Выдели 3-5 ключевых событий. Формат: короткие пункты с эмодзи. Не добавляй вступление и заключение."
                },
                {
                    "role": "user",
